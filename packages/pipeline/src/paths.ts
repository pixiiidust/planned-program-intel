...
export const GENERATED_CASES_PATH = join(DATA_DIR, 'proposals/generated-cases.json');
export const LABELLED_CASES_PATH = join(DATA_DIR, 'proposals/labelled-cases.json');
export const INTELLIGENCE_PROPOSAL_PATH = join(DATA_DIR, 'proposals/intelligence.json');
export const NARRATION_PROPOSAL_PATH = join(DATA_DIR, 'proposals/narration.json');
